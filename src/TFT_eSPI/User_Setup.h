...
// For ESP32 Dev board (ILI9341 display) Note:The hardware SPI can be mapped to any pins
...
// For ESP32 Dev board (ST7735 display) Note:The hardware SPI can be mapped to any pins
#define TFT_CS   5   // Chip select control pin
